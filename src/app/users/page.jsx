...
const ROLE_BASED_PERMISSIONS = {
    ...
    "กลุ่มสิทธิ์บัญชีและการเงิน (Finance/Accounting)": {
        "AP_READ": { label: "ดูข้อมูลบัญชีเจ้าหนี้ (AP)", desc: "เรียกดูยอดหนี้รอจ่าย และประวัติการจ่ายเงิน" },
        "AP_MANAGE": { label: "จัดการบัญชีเจ้าหนี้ (AP)", desc: "สร้างใบตั้งหนี้และบันทึกใบสำคัญจ่าย (PV)" },
        "AP_PAYMENT_MANAGE": { label: "บันทึกการจ่ายเงิน", desc: "บันทึกการจ่ายเงินและออกใบสำคัญจ่าย (PV)" },
        "AP_PAYMENT_VOID": { label: "ยกเลิกการจ่ายเงิน", desc: "ยกเลิกการจ่ายเงินที่บันทึกผิดพลาด (Void PV)" },
        "AP_PAYMENT_REQUEST": { label: "ขออนุมัติการจ่ายเงิน", desc: "ส่งคำขออนุมัติการจ่ายเงินไปยังผู้มีอำนาจอนุมัติ" },
        "AP_PAYMENT_APPROVE": { label: "อนุมัติการจ่ายเงิน", desc: "อนุมัติคำขอการจ่ายเงินที่ส่งมาจากเจ้าหน้าที่บัญชี" },
